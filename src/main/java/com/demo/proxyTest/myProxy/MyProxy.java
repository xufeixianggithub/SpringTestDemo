...
public class MyProxy {
    ...
    private static String path = "D:\\springSourceWorkSpace\\SpringTestDemo\\src\\main\\java\\com\\demo\\proxyTest\\myProxy";
    ...
    * */
    ...
    private static String getJavaStr(Class<?>[] interfaces) {
        ...
        String proxyClassStr = "package com.demo.proxyTest.myProxy;" + rt
